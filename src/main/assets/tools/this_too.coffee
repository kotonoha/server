...
thisTemplate = """<button class='btn btn-outline-primary btn-mini'><i class='fa fa-plus'></i> add me</button>"""
...
mod.directive 'thisToo', (thisTooSvc) ->
  restrict: 'A'
  template: """<button ng-show='full' class='btn btn-outline-primary btn-mini'><i class='fa fa-plus'></i> add me</button>"""
  scope: true
  replace: false
